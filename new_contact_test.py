...
class new_contact_test(unittest.TestCase):
    ...
    def test_new_contact_test(self):
        wd = self.wd
        self.open_homepage(wd)
        self.login(wd, username="admin", password="secret")
        self.create_contact(wd, fname="somename", mname="somemname", lname="somelname", nname="somenickname", title="sometitle", company="somecompany",
    ...
    def create_contact(self, wd, fname, mname, lname, nname, title, company, address1, homenum, mobnum, worknum, fax,
                       email1, email2, email3, homepage, birthyear, anniversary, address2, notes):
        ...
        wd.find_element_by_name("home").send_keys(homenum)
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys(mobnum)
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys(worknum)
        ...
        wd.find_element_by_name("ayear").send_keys(anniversary)
