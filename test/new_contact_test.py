...
def test_new_contact_test(application):
    application.session.login(username="admin", password="secret")
    application.contact.create(Contact(fname="somename", mname="somemname", lname="somelname", nname="somenickname", title="sometitle", company="somecompany",
